...
public class Softbody : MonoBehaviour
{
    ...
    public static Rigidbody AddCollider(ref GameObject go, ColliderShape shape, float size, float mass, bool lockPosition = false, bool lockRotation = false)
    {
        switch (shape)
        {
        ...
        // Lock the position and/or rotation of the Rigidbody if specified
        if (lockPosition)
        {
